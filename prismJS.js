document.addEventListener("DOMContentLoaded", function() {
  require([
    ...
    function applyCurrentSymbology() {
      const renderer = euPrismLayer.renderer.clone();
      ...
      euPrismLayer.renderer = renderer;
      euPrismLayer.elevationInfo = newElevationInfo;

      updateColorRampPreview(colorVV.stops);
    }

    function initializeSymbologyControls() {
      const currentRenderer = euPrismLayer.renderer;
